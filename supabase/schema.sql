...
create table if not exists payroll (
  ...
  "perDay" numeric default 0,
  "earnedBasic" numeric default 0,
  "earnedHra" numeric default 0,
  "earnedConveyance" numeric default 0,
  "earnedAllowances" numeric default 0,
  "earnedGross" numeric default 0,
  "lopDeduction" numeric default 0,
  "overtimeHours" numeric,
  "overtimeDays" numeric,
  "overtimeType" text,
  "overtimeAmount" numeric default 0,
  "foodIncentive" numeric default 0,
